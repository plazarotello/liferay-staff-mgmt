...
import com.telefonica.services.NoSuchEmployeeException;
import com.telefonica.services.model.Employee;
import com.telefonica.services.model.impl.EmployeeImpl;
import com.telefonica.services.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
	 ...
	 * @throws com.telefonica.services.NoSuchEmployeeException if a employee with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public Employee remove(long emp_id)
		throws NoSuchEmployeeException, SystemException {
		return remove(Long.valueOf(emp_id));
	}
	...
	protected Employee toUnwrappedModel(Employee employee) {
		...
		employeeImpl.setEmp_id(employee.getEmp_id());
		employeeImpl.setName(employee.getName());
		employeeImpl.setDpt_name(employee.getDpt_name());
		employeeImpl.setPhone_no(employee.getPhone_no());
		employeeImpl.setPhoto(employee.getPhoto());
	...
	/**
	 * Returns the employee with the primary key or throws a {@link com.telefonica.services.NoSuchEmployeeException} if it could not be found.
	 *
	 * @param emp_id the primary key of the employee
	 * @return the employee
	 * @throws com.telefonica.services.NoSuchEmployeeException if a employee with the primary key could not be found
	...
	public Employee findByPrimaryKey(long emp_id)
		throws NoSuchEmployeeException, SystemException {
		Employee employee = fetchByPrimaryKey(emp_id);

		if (employee == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + emp_id);
			}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Employee fetchByPrimaryKey(long emp_id) throws SystemException {
		Employee employee = (Employee)EntityCacheUtil.getResult(EmployeeModelImpl.ENTITY_CACHE_ENABLED,
				EmployeeImpl.class, emp_id);
		...
		if (employee == null) {
			...
			try {
				...
				if (employee != null) {
					...
					EntityCacheUtil.putResult(EmployeeModelImpl.ENTITY_CACHE_ENABLED,
						EmployeeImpl.class, emp_id, _nullEmployee);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.telefonica.services.model.Employee")));
